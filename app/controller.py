...
from app.playback_clock import ClockUpdateResult, PlaybackClock
...
from app.services.windows_startup import is_startup_enabled, set_startup_enabled
from app.services.windows_startup import is_supported as startup_is_supported
...
class AppController(QObject):
    ...
    def __init__(
        ...
        self._playback_clock = PlaybackClock()
    ...
    def _log_clock_update_debug(self, state: MediaState, update: ClockUpdateResult) -> None:
        now = time.monotonic()
